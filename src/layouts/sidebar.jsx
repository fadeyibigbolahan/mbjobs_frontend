...
export const Sidebar = forwardRef(({ collapsed }, ref) => {
  ...
  return (
    <aside
      ref={ref}
      className={cn(
        "fixed z-[100] flex h-full w-[240px] flex-col overflow-x-hidden border-r border-slate-300 bg-[#014581] [transition:_width_300ms_cubic-bezier(0.4,_0,_0.2,_1),_left_300ms_cubic-bezier(0.4,_0,_0.2,_1),_background-color_150ms_cubic-bezier(0.4,_0,_0.2,_1),_border_150ms_cubic-bezier(0.4,_0,_0.2,_1)] dark:border-slate-700 dark:bg-slate-900",
    ...
    >
      ...
      <div className="flex w-full flex-col gap-y-8 my-4 overflow-y-auto overflow-x-hidden pl-3 [scrollbar-width:_thin]">
        ...
        {user?.role == "admin" &&
          adminNavbarLinks.map((navbarLink) => (
            <nav
              key={navbarLink.title}
              className={cn(
                "sidebar-group text-white",
